...
function FilteredEventsPage() {
  ...
  const filteredData = router.query.slug; // This will be an array of the dynamic segments
  ...
  const date = new Date(numYear, numMonth - 1); // Create a date object for the filtered year and month
